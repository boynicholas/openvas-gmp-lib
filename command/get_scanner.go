...
type Scanner struct {
	...
	Permissions      *Permissions              `xml:"permissions" json:"permissions"`           // Permissions that the current user has on the scanner.
	UserTags         *UserTags                 `xml:"user_tags" json:"user_tags"`               // Info on tags attached to the chedule.
