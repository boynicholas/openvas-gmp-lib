...
type CreateTask struct {
	...
	Comment         string                 `xml:"comment" json:"comment"`                   // A comment on the task.
	Copy            string                 `xml:"copy" json:"copy"`                         // The UUID of an existing task.
	Alterable       bool                   `xml:"alterable" json:"alterable"`               // Whether the task is alterable.
	...
	Alert           *CreateTaskAlert       `xml:"alert" json:"alert"`                       // An alert that applies to the task.
	Schedule        *CreateTaskSchedule    `xml:"schedule" json:"schedule"`                 // When the task will run.
	...
	Observers       string                 `xml:"observers" json:"observers"`               // Users allowed to observe this task.
	Preferences     *CreateTaskPreferences `xml:"preferences" json:"preferences"`
}
